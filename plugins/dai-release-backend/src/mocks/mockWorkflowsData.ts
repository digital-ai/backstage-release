    ...
    workflows: [
      {
        ...
        description: "Easily create an application in Digital.ai Deploy that can be deployed to AWS Lambda, including its respective environment and infrastructure setup.",
        logoLink: "http://localhost/api/v1/templates/logo/Applications/FolderDefaultReleaseContent/Folder0a5f467c12cf41ce967092077b2138e5/Folder303182ca1d5443b2b63a0ff04eec5878/Release2bb84833587a48bf8af3943006e1acdf/TemplateLogo519cecd39c99458999a7101b405eb622",
        author: "Digital.ai",
        ...
        git: {
          commitId: "059d0a89",
          repoLink: "https://github.com/digital-ai/release-content/commit/059d0a89d6f6273a4f21cd437150197896f01920"
        }
      }
    ]
};
	...
	content: [
		{
			...
			scmTraceabilityData: {
				...
				date: 1730732523000,
				message: "[DigitalAIOfficial/25.1.1] Argo setup app don't send chart in case of git app (#85)",
				remote: "https://github.com/digital-ai/release-content",
				fileName: "DigitalAIOfficial/Releasefile.yaml",
			},
			folderId: "Applications/FolderDefaultReleaseContent/Folder0a5f467c12cf41ce967092077b2138e5/Folder303182ca1d5443b2b63a0ff04eec5878",
			folderTitle: "Digital.ai Deploy",
