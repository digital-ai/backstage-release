import {TemplateList, TemplateOverview} from "@digital-ai/plugin-dai-release-common";
    ...
    templates: [
        {
            ...
            title: "Configure Release",
            folder: "Deploy",
            newReleaseRedirectUri: "http://localhost/#/releases/create?fromTemplateId=Folder1-Release1",
        ...
        },
        {
            ...
            newReleaseRedirectUri: "http://localhost/#/releases/create?fromTemplateId=Folder2-Folder2-Folder1-Release2",
            titleRedirectUri: "http://localhost/#/templates/Folder2-Folder2-Folder1-Release2"
        }  ]
}